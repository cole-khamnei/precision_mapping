...
TEST_DTSERIES_PATH = f"{TEST_INPUTS_DIR}/example.dtseries.nii"
...
class TestPrecisionMapping(unittest.TestCase):
    ...
    def test_sparse_correlator(self):
        ...
        pm.utils.assert_exists(TEST_DTSERIES_PATH)
    ...
    def test_write_parcel_dlabels(self):
        ...
        pm.utils.assert_exists(TEST_DTSERIES_PATH)
        pm.write.write_parcel_dlabel(TEST_DTSERIES_PATH, TEST_SUPPLIED_PARCEL_PARTITION_PATH,
    ...
    def test_write_network_dlabels(self):
        ...
        pm.utils.assert_exists(TEST_DTSERIES_PATH)
        pm.write.write_network_dlabel(TEST_DTSERIES_PATH, TEST_SUPPLIED_NETWORK_PARTITION_PATH,
